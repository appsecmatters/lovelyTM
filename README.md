...
1. Draw you diagram with Import Sequence Diagram, using the [Mermaid syntax](https://mermaid.js.org/syntax/sequenceDiagram.html). Or just copy-paste the content of `examples/usecase1.json`
...
6. Click on the corresponding STRIDE letter(s) and Create Security Requirement(s) on the attack scenario(s): any technical solution/process/documentation that would make the attack more difficult (and hence reduce the business risk). Provide the updated technical/logistics difficulty and an estimation of the implementation effort.
